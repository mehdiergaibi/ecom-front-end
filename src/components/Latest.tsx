    ...
    return (
        <div className="container pt-16">
          <div className="lg:flex justify-between items-center">
            <div>
              <h3 className="font-medium text-2x1">Latest</h3>
              <p className="text-gray-600 mt-2">
              discover what's hot right now and elevate your shopping experience with our picks.
              </p>
            </div>
           ...
           <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 pt-8 gap-2">
                {
            latestClothes.map( (clothe) => <ProductCard
                key={clothe.id}
                img={clothe.img}
                name={clothe.name}
                price={clothe.price}
